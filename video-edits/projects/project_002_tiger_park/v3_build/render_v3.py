...
shots = [
    ...
    (9.0,   12.0, "photo_CENTER", "tiger_sit_platform.jpeg",  None, True),
    (12.0,  16.0, "BLACK",        None, None, False),
    (16.0,  19.0, "video_LEFT",   "IMG_3489.mp4", 5,  False),
    (19.0,  22.0, "photo_CENTER", "tiger_close_left.jpeg", None, True),
    # M3 Process (22-44)
    (22.0,  26.0, "video_CENTER", "IMG_3489.mp4", 50, False),
    (26.0,  30.0, "photo_CENTER", "tiger_lying_full.jpeg", None, False),
    ...
    (83.0,  87.0, "photo_CENTER", "tiger_belly_paws_up.jpeg", None, False),  # ⭐ BELLY
    (87.0,  92.0, "BLACK",        None, None, False),
    (92.0,  95.0, "photo_CENTER", "tiger_lying_full.jpeg", None, False),
    # M7 Insight (95-108.2)
