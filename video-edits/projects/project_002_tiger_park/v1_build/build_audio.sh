...
# voice.wav already exists (68.1s, processed)
DUR=68.1

# 6 whoosh SFX events on sharp moments
SFX_LIST=(
  "0.10|vylet_1.mp3|0.70"                        # hook open
  "7.00|fireball_whoosh_05224.mp3|0.85"          # cut to "Tiger World"
  "19.00|fast_blow_whoosh.mp3|1.00"              # BIG drop "5 ЭНЕРГИЙ"
  "34.00|whoosh_grainy_2.mp3|0.85"               # transition to lesson
  "54.00|fireball_whoosh.mp3|1.00"               # CLIMAX "открывает живот"
  "63.00|dust_whooshes.mp3|0.85"                 # CTA card "МИР У ТВОИХ НОГ"
)
