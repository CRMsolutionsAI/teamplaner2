...
texts = [
    ...
    # v11: shift 36s+ subtitles earlier — user said they lag from 0:36
    (35.40, 40.5,  "= 161 ГРН",    FONT_CAVEAT, 110, WHITE, "(w-tw)/2", "1180", ""),
    (36.50, 40.5,  "за уникальность", FONT_CAVEAT, 70, ORANGE, "(w-tw)/2", "1320", ""),
    (40.40, 42.83, "ЭМОЦИЯ",       FONT_BLACK, 130, WHITE,  "(w-tw)/2", "220", ""),
    (40.80, 42.83, "не чехол",     FONT_CAVEAT, 90, ORANGE, "(w-tw)/2", "390", ""),

    # M5 Finale — shift earlier too
    (42.60, 46.30, "ВАШ",          FONT_BLACK, 180, WHITE,  "(w-tw)/2", "180", ""),
    (42.90, 46.30, "ПАСПОРТ",      FONT_BLACK, 200, WHITE,  "(w-tw)/2", "380", ""),
    (43.70, 46.30, "— ваша история", FONT_CAVEAT, 120, ORANGE, "(w-tw)/2", "1600", ""),
    # 46.5-48.6 BLACK CTA card — big multi-tier question text (user request)
    (46.30, 48.6,  "А ВО ЧТО",         FONT_BOLD,  120, WHITE,  "(w-tw)/2", "560", ""),
    (46.60, 48.6,  "ОДЕТЫ",            FONT_BLACK, 160, ORANGE, "(w-tw)/2", "740", ""),
    (47.00, 48.6,  "ВАШИ",             FONT_BOLD,  100, WHITE,  "(w-tw)/2", "1000", ""),
    (47.20, 48.6,  "ДОКУМЕНТЫ?",       FONT_BLACK, 140, WHITE,  "(w-tw)/2", "1140", "box=1:boxcolor=0xFF5722:boxborderw=30"),
]
