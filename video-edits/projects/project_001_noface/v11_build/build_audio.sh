...
SFX_LIST=(
  ...
  "32.90|unnamed_5.mp3|0.95"                     # 120 BAT IMPACT — short
  "35.40|tv_static.mp3|0.75"                     # = 161 ГРН (was sfx_04295 11.7s REWIND-feel, now 0.96s glitch)
  "40.40|whoosh_grainy_3.mp3|0.85"               # ЭМОЦИЯ не чехол
  "42.60|fireball_whoosh.mp3|0.85"               # ВАШ ПАСПОРТ (was trailer_spaceship 7.2s REWIND, now 3.2s)
  "46.30|vylet_2.mp3|0.80"                       # CTA black-card question
)
# v11: replaced 2 long rewind-feel sounds — sfx_04295 (11.7s) and trailer_spaceship (7.2s).
# All SFX now <= 3.2s. Timestamps shifted earlier to match new subtitle timing.
