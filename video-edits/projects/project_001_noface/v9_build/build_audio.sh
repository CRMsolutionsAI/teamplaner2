...
SFX_LIST=(
  ...
  "22.50|dust_whooshes.mp3|0.75"                 # ТАКТИЛЬНО cut
  "24.00|unnamed_2.mp3|0.75"                     # НАДЁЖНО cut (NEW)
  "25.57|unnamed_1.mp3|0.75"                     # СОЕДИНЯЕТ ДЕТАЛИ
  "27.50|proletai_transition.mp3|0.75"           # cut to finishing (was film_humming_flight)
  "29.91|sfx_04715.mp3|0.80"                     # NATALIA reveal (voice phrase)
  "32.90|trailer_buildup.mp3|0.95"               # 120 BIG IMPACT — voice 33.05
  "36.03|sfx_04295.mp3|0.75"                     # = 161 ГРН
  "38.50|unnamed_3.mp3|0.75"                     # cut to open_inside (NEW)
  "40.88|whoosh_grainy_3.mp3|0.85"               # ЭМОЦИЯ не чехол
  "43.15|trailer_spaceship.mp3|0.90"             # ВАШ ПАСПОРТ finale
  "44.70|unnamed_4.mp3|0.70"                     # cut to interior detail (NEW)
