"""v7 render — premium hook animations, M4 realigned to voice."""
import subprocess
import os
...
shots = [
    # M2 (6.36-18.18) Night market — keep as in v6
    (6.36, 9.08,  "video_letterbox",   f"{FOOTAGE}/IMG_0620_night_market_lanterns.mp4", 0, None),
    (9.08, 12.10, "video_frame",       f"{FOOTAGE}/IMG_0468.mp4", 0, 1.0),
    (12.10, 13.49, "video_frame",      f"{FOOTAGE}/IMG_0932.mp4", 0.5, 1.0),
    (13.49, 15.12, "video_frame",      f"{FOOTAGE}/IMG_0506.mp4", 0, 1.05),
    (15.12, 17.59, "video_frame",      f"{FOOTAGE}/IMG_0468.mp4", 1.5, 1.2),
    (17.59, 18.94, "video_frame",      f"{FOOTAGE}/IMG_1110.mp4", 0, 1.1),
    # M3 (18.94-32.7) Process
    (18.94, 20.77, "video_frame",      f"{FOOTAGE}/IMG_1110.mp4", 0.2, 1.1),
    (20.77, 23.5,  "video_frame",      f"{FOOTAGE}/IMG_0932.mp4", 3.0, 1.0),
    (23.5, 25.57,  "video_frame",      f"{FOOTAGE}/IMG_0468.mp4", 1.0, 1.3),
    (25.57, 28.5,  "video_frame",      f"{FOOTAGE}/IMG_1110.mp4", 0.3, 1.4),
    (28.5, 32.7,   "png_zoom",         f"{PHOTOS}/cover_black_mustache_clean.png", 1.0, 1.08),
    # M4 (32.7-43.14) Value/120 — REALIGNED: voice says "120 БАТ" at 33.0
    (32.7, 33.01,  "png_zoom",         f"{PHOTOS}/cover_green_dragon_clean.png", 0.92, 0.96),  # quick shrink
    (33.01, 36.03, "black",            None, None, None),  # BIG 120 reveal aligned with voice
    (36.03, 40.88, "black",            None, None, None),  # = 161 ГРН / за уникальность
    (40.88, 43.14, "png_zoom",         f"{PHOTOS}/cover_green_dragon_clean.png", 0.88, 1.04),
    # M5 (43.14-48.6) Finale
    (43.14, 46.0,  "png_zoom",         f"{PHOTOS}/cover_green_dragon_clean.png", 0.95, 1.08),
    (46.0, 48.62,  "png_two_covers_finale", None, None, None),
]
