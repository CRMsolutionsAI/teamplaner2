...
texts = [
    ...
    # M3 Process
    (18.78, 20.54, "МАСТЕР",       FONT_BLACK, 140, WHITE,  "(w-tw)/2", "180", ""),
    (20.62, 22.5,  "ПАРУ МИНУТ",   FONT_BOLD,  90,  WHITE,  "(w-tw)/2", "200", ""),
    (21.0, 25.0,   "+МАГИЯ",       FONT_CAVEAT, 130, ORANGE, "(w-tw)/2", "340", ""),
    (22.7, 25.0,   "ТАКТИЛЬНО",    FONT_BOLD,  110, WHITE,  "(w-tw)/2", "200", ""),
    (23.5, 25.0,   "НАДЁЖНО",      FONT_BOLD,  110, ORANGE, "(w-tw)/2", "340", ""),
    (25.42, 27.5,  "СОЕДИНЯЕТ",    FONT_BOLD,  100, WHITE,  "60", "220", ""),
    (25.80, 27.5,  "ВСЕ ДЕТАЛИ",   FONT_BOLD,  100, ORANGE, "180", "360", ""),
    (28.5, 32.7,   "NATALIA",      FONT_BLACK, 90, ORANGE,  "(w-tw)/2", "1480", "box=1:boxcolor=white@0.95:boxborderw=25"),
    (29.0, 32.7,   "имя на обложке", FONT_CAVEAT, 60, WHITE, "(w-tw)/2", "1680", ""),

    # M4 Value/120 — KEY FIX: voice says "120 БАТ" at 33.01
    (32.70, 33.40, "ЦЕНА",         FONT_BLACK, 130, WHITE,  "(w-tw)/2", "200", ""),
    (32.86, 35.8,  "120",          FONT_BLACK, 380, WHITE,  "(w-tw)/2", "550", "box=1:boxcolor=0xFF5722:boxborderw=40"),
    (33.30, 35.8,  "БАТ",          FONT_BLACK, 110, ORANGE, "(w-tw)/2", "1020", ""),
    (35.85, 36.42, "= 161 ГРН",    FONT_CAVEAT, 110, WHITE, "(w-tw)/2", "1180", ""),
    (36.45, 40.5,  "= 161 ГРН",    FONT_CAVEAT, 110, WHITE, "(w-tw)/2", "1180", ""),
    (36.55, 40.5,  "за уникальность", FONT_CAVEAT, 70, ORANGE, "(w-tw)/2", "1320", ""),
