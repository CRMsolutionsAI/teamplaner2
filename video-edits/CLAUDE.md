...
1. Прочитать `PROGRESS.md` — там точный статус
2. Прочитать `refs_knowledge.md` — все накопленные техники
3. Спросить пользователя: к какому видео применяем / что монтируем
...
## Что НЕ лежит в репо (только локально / нужно загрузить)

- **Исходники видео** (`in.mp4`, `plan_in.mp4`) — большие, у пользователя на Mac
- **Музыкальные треки** — у пользователя в категориях
- **Промежуточные рендеры** — не нужны, легко регенерить
