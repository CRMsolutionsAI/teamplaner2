...
|---|---|---|
| `wispr_positive.mp3` | Категория «Что-то позитивное», ID `b6e2673f` | Wispr Flow v9 |
...
### Категория «История любви» (`love_story/`)

Когда применять: эмоциональные ролики, истории отношений, тёплые персональные истории.

| Файл | Длительность |
|---|---|
| `love_story/track_01_139s.mp3` | 2:19 |
| `love_story/track_02_140s.mp3` | 2:20 |
| `love_story/track_03_178s.mp3` | 2:58 |
| `love_story/track_04_155s.mp3` | 2:35 |
| `love_story/track_05_194s.mp3` | 3:14 |

### Категория «Глубокое погружение» (`deep_immersion/`)

Когда применять: инсайт, обучение, интеллектуальный продукт, размышления.

| Файл | Длительность | Заметки |
|---|---|---|
| `deep_immersion/track_16_175s.mp3` | 2:55 | |
| `deep_immersion/track_17_325s.mp3` | 5:25 | ID `da85ec67`, использован в Wispr Flow v6+ |
| `deep_immersion/track_20_227s.mp3` | 3:47 | |
| `deep_immersion/track_22_309s.mp3` | 5:09 | |
| `deep_immersion/track_23_240s.mp3` | 4:00 | |

### Категория «Что-то позитивное» (`positive/`)

Когда применять: энергия, продукт-демо, позитивный мессадж.

| Файл | Длительность | Заметки |
|---|---|---|
| `positive/track_03_153s.mp3` | 2:33 | |
| `positive/track_07_198s.mp3` | 3:18 | ID `b6e2673f`, использован в Wispr Flow v9 (legacy `wispr_positive.mp3`) |
| `positive/track_09_87s.mp3` | 1:27 | |

**⚠️ Cross-category track:** `aqualina_orange_hues_201s.mp3` (track #2 в «позитивное») находится также в `all_good_now/` — Наталья использует его в обеих категориях. Не дублирую файл, держу в `all_good_now/`.
